...
// ported from the `client` branch. Note: DmsAccess-related types
// (DmsItemType, GrantAccessRequest, DmsAccessListItem, etc.) intentionally
// live in dmsNotification.model.ts instead — that's the current, spec-driven
// version of the DmsAccess contract; client's older duplicates of those
// aren't ported here to avoid confusion between the two.
