...
export class ReviewRoleComponent {
  constructor(private modalService: NgbModal, private fb: FormBuilder, public apiService: ApiService,private notifier: NotifierService,@Optional() public activeModel:NgbActiveModal) { }
  @Input()
  modal: any;
  roles: RolesModels = {};
