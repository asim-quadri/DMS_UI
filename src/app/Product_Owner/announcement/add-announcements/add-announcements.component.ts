...
formgroup: FormGroup = this.fb.group({
  ...
  onSubmit() {
    ...
    if (this.formgroup.valid) {
      ...
      // Create the announcement object with proper type handling
      var annoucement: any = {
        regulationId: formValues.regulationId === '' || formValues.regulationId === null ? null : Number(formValues.regulationId),
        complianceId: formValues.complianceId === '' || formValues.complianceId === null ? null : Number(formValues.complianceId),
        tocId: formValues.tocId === '' || formValues.tocId === null ? null : Number(formValues.tocId),
        registerId: formValues.registerId === '' || formValues.registerId === null ? null : Number(formValues.registerId),
        createdDate: formValues.createdDate,
        applicableDate: formValues.applicableDate,
        description: formValues.description,
        subject: formValues.subject,
        announcementReferencecode: formValues.announcementReferencecode,
        createdByName: formValues.createdByName,
        createdBy: this.persistance.getUserId()!,
        approvalManagerId: this.persistance.getManagerId(),
        
      };

      // If in edit mode, include the announcement ID for update
      if (this.ActionType === 'Edit' && this.announcementId) {
        annoucement.id = this.announcementId;
      }
